...
def analisar_imagem_colorida(frame, salvar_resultado=True, caminho_saida="resultado_para_profissional.jpg"):
    ...
    cv2.putText(frame, f"L: {mmx} mm", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
    cv2.putText(frame, f"A: {mmy} mm", (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
